...
const siteName = 'ANZ'
const description = `
ANZ証券は機関投資家向けのサービスに特化しています。 ANZは、投資学習、市場調査、戦略交流に特化した総合型プラットフォームです。異なる段階の投資家に対して、明確で理解しやすく、検証可能な投資参考情報を提供することを目指しております。プラットフォームは、理性的な投資とリスク管理を核心理念とし、体系的な市場分析、
